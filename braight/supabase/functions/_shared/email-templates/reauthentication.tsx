...
export const ReauthenticationEmail = ({ token }: ReauthenticationEmailProps) => (
  <Html lang="de" dir="ltr">
    <Head />
    <Preview>Dein Bestätigungscode für brAIght</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={textSmall}>
          Der Code ist nur kurze Zeit gültig. Falls du dies nicht angefordert hast, kannst du diese E-Mail ignorieren.
        </Text>
        <Text style={footer}>
